package ua.homca.jforum.util.legacy.clickstream;
...
import ua.homca.jforum.util.legacy.clickstream.config.ClickstreamConfig;
import ua.homca.jforum.util.legacy.clickstream.config.ConfigLoader;
